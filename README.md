...
This project presents an interactive Supermarket Sales Performance Dashboard developed using Microsoft Power BI to analyze sales performance for January 2024.

The dashboard provides an overview of sales performance across different cities, product categories, and customer types, while also showing daily sales trends. It was designed to transform raw sales data into clear and interactive insights that can support better business understanding and decision-making.

🎯 Project Objective

The main objective of this project was to analyze supermarket sales data and identify key patterns in:
...
Abuja generated the highest revenue, contributing approximately 45% of total sales.
